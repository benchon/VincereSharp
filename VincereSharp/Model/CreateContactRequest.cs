namespace VincereSharp
{
    ...
    public partial class CreateContactRequest
    {
        ...
        [JsonProperty("contact_source_id")]
    ...
    public partial class CreateContactRequest
    {
        public static CreateContactRequest FromJson(string json) => JsonConvert.DeserializeObject<CreateContactRequest>(json, VincereSharp.Converter.Settings);
    }
}
